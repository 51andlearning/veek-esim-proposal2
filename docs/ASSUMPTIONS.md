...
This proposal is directional. The following assumptions must be reviewed and validated by Veek before any execution work begins.
...
## Data access
- **No internal Veek data access.** All figures, benchmarks, and estimates are external or inferred.
- No Veek CRM, billing, Gigacoins, or app analytics were queried during authorship.
- All customer-base, ARPU, attach-rate, and revenue figures are placeholders pending validation against Veek's own data.
...
## Validation required post-approval
Before launch, the following require Veek confirmation:
- Active customer base, segmentation, and outbound-travel propensity by tier (Freemium / Premium / Ultra).
- Bundle pricing in BRL and Gigacoins.
- Commercial split with the MVNE partner.
- KPI definitions and success thresholds (attach rate, repeat rate, churn impact).
- Brand and voice guardrails (logo usage, tone, app surfaces eligible for travel-eSIM placement).
- Legal, privacy, and regulatory constraints (ANATEL, LGPD, cross-border data).
- Internal team capacity and delivery ownership at Veek.
